...
use Ghazniali95\ShopifyConnector\App\Exception\InvalidWebhookException;
use Ghazniali95\ShopifyConnector\App\Exception\MissingWebhookHandlerException;
use Ghazniali95\ShopifyConnector\App\Exception\WebhookRegistrationException;
...
final class Registry
{
     ...
     *
     * @return \ShopifyConnector\App\Classes\Webhooks\RegisterResponse
     ...
     * @throws \ShopifyConnector\App\Classes\Exception\WebhookRegistrationException
     */
     ...
     *
     * @throws \ShopifyConnector\App\Classes\Exception\InvalidWebhookException
     * @throws \ShopifyConnector\App\Classes\Exception\MissingWebhookHandlerException
     */
     ...
     *
     * @param \ShopifyConnector\App\Classes\Clients\Graphql         $client
     * @param string                           $topic
     * @param string                           $callbackAddress
     * @param \ShopifyConnector\App\Classes\Webhooks\DeliveryMethod $method
     *
     * @return array
     *
     ...
     * @param string                           $topic
     * @param string                           $callbackAddress
     * @param \ShopifyConnector\App\Classes\Webhooks\DeliveryMethod $deliveryMethod
